...
{
  "$end", "error", "$undefined", "RESISTOR", "CAPACITOR", "INDUCTOR",
  "VSOURCE", "ISOURCE", "NODE", "VALUE", "$accept", "commands", YY_NULLPTR
};
#endif
...
#line 30 "test.y" /* yacc.c:1646  */
    {storeResistor((yyvsp[0].stringValue));}
